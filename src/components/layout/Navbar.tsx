...
const Navbar = () => {
  ...
  // --- Unconditional Hook Calls (Best Practice for React) ---
  const homeHeaderOpacity = useTransform(scrollY, [120, 220], [0, 1])
  const headerOpacity = isHome ? homeHeaderOpacity : 1
