...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-full min-h-[500px] lg:min-h-screen flex justify-center items-center transform scale-100 origin-center cursor-grab active:cursor-grabbing">
      <Canvas
        camera={{ position, fov }}
